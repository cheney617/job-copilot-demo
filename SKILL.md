...
> 没有代码执行能力的 AI：忽略本文件，直接按 `skill/求职工作台方法论.md` 走对话模式。
...
2. **首次设置（对话完成，5-10 分钟）**：按 `skill/求职工作台方法论.md` 的第 0-3 步执行——收简历、出核心竞争力判定卡、问卷（能选不填）、定薪资基准线。方法论文件是唯一权威，答题纪律、行业校准、红线全在里面
